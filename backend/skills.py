...
BUILTIN_SKILLS = [
    ...
    },
    {
        "id": "web-browse",
        "name": "Web Browse",
        "description": "Navigate websites, extract structured data, and follow links",
        "category": "Research",
        "icon": "public",
        "builtin": True,
    },
    {
        "id": "code-review",
        "name": "Code Review",
        "description": "Automated code review with best-practice checks and suggestions",
        "category": "Development",
        "icon": "rate_review",
        "builtin": True,
    },
    {
        "id": "test-runner",
        "name": "Test Runner",
        "description": "Run test suites, parse results, and report coverage",
        "category": "Development",
        "icon": "science",
        "builtin": True,
    },
    ...
    },
    {
        ...
        "description": "Profile runtime performance, detect bottlenecks, and suggest optimizations",
        "category": "Development",
        "icon": "trending_up",
        "builtin": True,
    },
    {
        "id": "docker-manage",
        "name": "Docker Manage",
        "description": "Build, run, stop, and inspect Docker containers and images",
        "category": "System",
        "icon": "dns",
        "builtin": True,
    },
    {
        "id": "system-monitor",
        "name": "System Monitor",
        "description": "Monitor CPU, memory, disk, network, and running processes",
        "category": "System",
        "icon": "monitor_heart",
        "builtin": True,
    },
